...
public class FeaturedProductsAdapter extends RecyclerView.Adapter<FeaturedProductsAdapter.ViewHolder> {
    ...
    public FeaturedProductsAdapter(Context mcontext, List<FeaturedProductsModel.ProductData> list) {
    ...
    @NonNull
    @Override
    public FeaturedProductsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mcontext).inflate(R.layout.featured_products_row_item, viewGroup, false);
        return new ViewHolder(view, itemClickListner);
    }

    @Override
    public void onBindViewHolder(@NonNull FeaturedProductsAdapter.ViewHolder viewHolder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, final RecyclerOnItemClickListner listner) {
            super(itemView);
            cart_image = itemView.findViewById(R.id.featuredProd_cart_img_id);
            wishlist_image = itemView.findViewById(R.id.featuredProd_wishlist_img_id);
            item_image = itemView.findViewById(R.id.featuredProd_item_imageV_id);
            item_title = itemView.findViewById(R.id.featuredProd_item_title_txtV_id);
            item_price = itemView.findViewById(R.id.featuredProd_item_price_txtV_id);
